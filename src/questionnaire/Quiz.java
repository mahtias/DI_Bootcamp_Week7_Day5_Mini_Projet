/**
 * @author N'ZO LAGOU
 * Création d'un jeu de quiz simple en Java qui implémente l'approche POO

Utilisez la liste de questions ci-dessous.

Créez une Questionclasse avec 2 variables :

prompt- pour la question
answer- pour la réponse
Demandez à l'utilisateur la bonne réponse à une question :

Imprimez les questions les unes après les autres
Obtenir l'entrée de l'utilisateur pour une réponse
Calculer le score des bonnes réponses
 */
...
public class Quiz {
	 ...
	 * qf. Each correct answer counts for 1 point.
	 */
		...
		public static void main(String[] args) {
			...
			quiz.addQuestion(new Question(q1, 'b')).addQuestion(new Question(q2, 'a'))
					.addQuestion(new Question(q3, 'b')).addQuestion(new Question(q4, 'c'))
					.addQuestion(new Question(q5, 'a')).addQuestion(new Question(q6, 'a'))
					.addQuestion(new Question(q7, 'a')).addQuestion(new Question(q8, 'c'))
					.addQuestion(new Question(q9, 'a')).addQuestion(new Question(qF, 'c'));
